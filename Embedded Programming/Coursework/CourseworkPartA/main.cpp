	...
	int32_t r0,r1,r2,r3;
	 ...
	 for (row = 1; row < N-1; row++) {
		for (col = 1; col < M-1; col+=2) {
			...
			r0=* ((uint32_t *) &inp_img[row-1][col-1]);
			r1=* ((uint32_t *) &gaussianMask[0][0]);
			r2 = __smlad(r0,r1,r2);
			newPixel += r2;
			r2 = 0;
			newPixel += inp_img[row-1][col+1] * gaussianMask[0][2];


			r0=* ((uint32_t *) &inp_img[row][col-1]);
			r1=* ((uint32_t *) &gaussianMask[1][0]);
			r2 = __smlad(r0,r1,r2);
			newPixel += r2;
			r2 = 0;
			
			newPixel += inp_img[row][col+1] * gaussianMask[1][2];

			r0=* ((uint32_t *) &inp_img[row+1][col-1]);
			r1=* ((uint32_t *) &gaussianMask[2][0]);
			r2 = __smlad(r0,r1,r2);
			newPixel += r2;
			r2 = 0;
			
			newPixel += inp_img[row+1][col+1] * gaussianMask[2][2];
			
		out_img[row][col] = newPixel / 16;

			newPixel = 0;

			r0=* ((uint32_t *) &inp_img[row-1][col]);
			r1=* ((uint32_t *) &gaussianMask[0][0]);
			r2 = __smlad(r0,r1,r2);
			newPixel += r2;
			r2 = 0;
			newPixel += inp_img[row-1][col+2] * gaussianMask[0][2];


			r0=* ((uint32_t *) &inp_img[row][col]);
			r1=* ((uint32_t *) &gaussianMask[1][0]);
			r2 = __smlad(r0,r1,r2);
			newPixel += r2;
			r2 = 0;
			
			newPixel += inp_img[row][col+2] * gaussianMask[1][2];
			...
			newPixel += inp_img[row+1][col+2] * gaussianMask[2][2];
			
		out_img[row][col+1] = newPixel / 16;
		}
	}
}
	...
	int32_t r0,r1,r2,r3;
		...
		for (col = 1; col < M-1; col++) {
			...
			//Calculate the sum of the Sobel mask times the nine surrounding pixels in the x and y direction 
					...
					r0=* ((uint32_t *) &out_img[row-1][col-1]);
					r1=* ((uint32_t *) &GxMask[0][0]);
					r2 = __smlad(r0,r1,r2);
					Gx += r2;
					Gx += out_img[row-1][col+1] * GxMask[0][2];
					r2 = 0;

					r0=* ((uint32_t *) &out_img[row-1][col-1]);
					r1=* ((uint32_t *) &GyMask[0][0]);
					r2 = __smlad(r0,r1,r2);
					Gy += r2;
					Gy += out_img[row-1][col+1] * GyMask[0][2];
					r2 = 0;

					r0=* ((uint32_t *) &out_img[row][col-1]);
					r1=* ((uint32_t *) &GxMask[1][0]);
					r2 = __smlad(r0,r1,r2);
					Gx += r2;
					Gx += out_img[row][col+1] * GxMask[1][2];
					r2 = 0;

					r0=* ((uint32_t *) &out_img[row][col-1]);
					r1=* ((uint32_t *) &GyMask[1][0]);
					r2 = __smlad(r0,r1,r2);
					Gx += r2;
					Gy += out_img[row][col+1] * GyMask[1][2];
					r2 = 0;

					r0=* ((uint32_t *) &out_img[row+1][col-1]);
					r1=* ((uint32_t *) &GxMask[2][0]);
					r2 = __smlad(r0,r1,r2);
					Gx += r2;
					Gx += out_img[row+1][col+1] * GxMask[2][2];
					r2 = 0;

					r0=* ((uint32_t *) &out_img[row+1][col-1]);
					r1=* ((uint32_t *) &GyMask[2][0]);
					r2 = __smlad(r0,r1,r2);
					Gy += r2;
					Gy += out_img[row+1][col+1] * GyMask[2][2];
					r2 = 0;
